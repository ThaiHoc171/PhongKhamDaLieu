namespace Clinic.WinForms.Forms.LoaiBenh
{
	partial class LoaiBenhForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtSearch.PlaceholderText = "Tìm kiếm loại bệnh...";
			...
			this.btnAdd.Text = "Thêm loại bệnh";
			...
			this.Name = "LoaiBenhForm";
			this.Text = "LoaiBenhForm";
			this.Load += new System.EventHandler(this.LoaiBenhForm_Load);
