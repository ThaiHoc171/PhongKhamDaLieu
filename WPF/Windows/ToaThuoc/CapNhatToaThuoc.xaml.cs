...
public partial class CapNhatToaThuoc : Window
{
	public CapNhatToaThuoc(int phienKhamId)
	{
		InitializeComponent();
		_id = phienKhamId;
	...
	private async void CapNhatToaThuoc_Loaded(object sender, RoutedEventArgs e)
	{
		await LoadComboBox();
