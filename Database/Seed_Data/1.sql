...
VALUES
(14, N'Dương Minh Tùng', '1988-02-12', N'Nam', '0915001002', 'minhduong@example.com', N'Q6, TP.HCM', N'Bệnh nhân'),
(15, N'Phạm Hoài Linh', '1999-07-22', N'Nữ', '0915001003', 'phamhoailinh@example.com', N'Q7, TP.HCM', N'Bệnh nhân'),
(16, N'Lê Thành Đạt', '1985-11-16', N'Nam', '0915001004', 'lethanhdat@example.com', N'Q8, TP.HCM', N'Bệnh nhân'),
(17, N'Truơng An Tú', '1990-05-19', N'Nam', '0915001005', 'truonganhtu@example.com', N'Tân Phú', N'Bệnh nhân'),
(18, N'Đặng Thu Phương', '1994-09-13', N'Nữ', '0915001006', 'dangthuphuong@example.com', N'Q10', N'Bệnh nhân'),
(19, N'Hoàng Long Lâm', '2001-03-21', N'Nam', '0915001007', 'hoanglonglam@example.com', N'Q3', N'Bệnh nhân'),
(20, N'Trúc Lan', '1998-10-01', N'Nữ', '0915001008', 'truclan98@example.com', N'Q1', N'Bệnh nhân'),
(21, N'Kim Yến', '2003-06-25', N'Nữ', '0915001009', 'kimyen03@example.com', N'Q2', N'Bệnh nhân'),
(22, N'Anh Thành', '1987-08-12', N'Nam', '0915001010', 'anhthanh87@example.com', N'Q11', N'Bệnh nhân'),
(23, N'Phạm Hải Đăng', '1991-01-14', N'Nam', '0915001011', 'phamhaidang@example.com', N'Q12', N'Bệnh nhân'),
(24, N'Hữu Kỳ', '1993-03-07', N'Nam', '0915001012', 'huuky@example.com', N'Q9', N'Bệnh nhân'),
(25, N'Lân Anh Phạm', '1995-12-04', N'Nữ', '0915001013', 'lananhpham@example.com', N'Q7', N'Bệnh nhân'),
(26, N'Nhật Nam', '2000-04-22', N'Nam', '0915001014', 'nhatnam07@example.com', N'Q2', N'Bệnh nhân'),
(27, N'Trương Gia Khang', '2010-09-30', N'Nam', '0915001015', 'truonggiakhang@example.com', N'Q6', N'Bệnh nhân'),
(28, N'Thanh Như', '1999-12-17', N'Nữ', '0915001016', 'thanhnhu99@example.com', N'Q8', N'Bệnh nhân'),
(29, N'Vương Kim Anh', '1996-01-25', N'Nữ', '0915001017', 'vuongkimanh@example.com', N'Q9', N'Bệnh nhân'),
(30, N'Quang Huy', '1992-06-14', N'Nam', '0915001018', 'quanghuy92@example.com', N'Q10', N'Bệnh nhân'),
(31, N'Tiến Trần', '1985-03-20', N'Nam', '0915001019', 'tientran85@example.com', N'Q3', N'Bệnh nhân'),
(32, N'Dũng Phạm', '1997-11-09', N'Nam', '0915001020', 'dungpham97@example.com', N'Q4', N'Bệnh nhân'),
(33, N'Hoài Lan Phạm', '1994-04-04', N'Nữ', '0915001021', 'hoailanpham@example.com', N'Q7', N'Bệnh nhân'),
(34, N'Linh Chi', '2003-05-11', N'Nữ', '0915001022', 'linhchi03@example.com', N'Q5', N'Bệnh nhân'),
(35, N'Hoàng Phương', '1994-11-06', N'Nữ', '0915001023', 'hoangphuong94@example.com', N'Q8', N'Bệnh nhân'),
(36, N'Kiến Hưng', '1990-02-03', N'Nam', '0915001024', 'kienhung90@example.com', N'Q10', N'Bệnh nhân'),
(37, N'Thanh Võ', '1988-07-12', N'Nam', '0915001025', 'thanhvo88@example.com', N'Q11', N'Bệnh nhân'),
(38, N'Huệ Phan', '2002-08-30', N'Nữ', '0915001026', 'huephan02@example.com', N'Q12', N'Bệnh nhân'),
(39, N'Tuyết Nhung', '1993-09-27', N'Nữ', '0915001027', 'tuyetnhung@example.com', N'Q4', N'Bệnh nhân'),
(40, N'Thiện Minh', '2004-03-15', N'Nam', '0915001028', 'thienminh04@example.com', N'Q5', N'Bệnh nhân'),
(41, N'Gia Hân', '1999-06-12', N'Nữ', '0915001029', 'giahan99@example.com', N'Q6', N'Bệnh nhân'),
(42, N'Ngọc Anh', '1991-02-18', N'Nữ', '0915001030', 'ngocanh91@example.com', N'Q1, TP.HCM', N'Bệnh nhân'),
(43, N'Hoàng Sơn', '1986-07-09', N'Nam', '0915001031', 'hoangson86@example.com', N'Q3, TP.HCM', N'Bệnh nhân');
GO
-- BenhNhan--
